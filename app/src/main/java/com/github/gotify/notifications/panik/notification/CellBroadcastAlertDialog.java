...
import com.github.gotify.notifications.panik.misc.CellBroadcastChannelManager;
import com.github.gotify.notifications.panik.misc.CellBroadcastResources;
...
public class CellBroadcastAlertDialog extends Activity {
    ...
    public class AnimationHandler extends Handler {
        ...
        private boolean initDrawableAndImageView(int subId) {
            if (mWarningIcon == null) {
                try {
                    mWarningIcon = CellBroadcastSettings.getResources(getApplicationContext(), subId).getDrawable(com.github.gotify.R.drawable.ic_warning_googred);
            ...
            if (mWarningIconView == null) {
                mWarningIconView = (ImageView) findViewById(com.github.gotify.R.id.icon);
                if (mWarningIconView != null) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(inflater.inflate(com.github.gotify.R.layout.cell_broadcast_alert, null));

        findViewById(com.github.gotify.R.id.dismissButton).setOnClickListener(v -> dismiss());
